...
PARAMS = {
    'action' :'query',
    'list': 'search',
    'srsearch': 'haswbstatement:P180=Q830',
    'srnamespace': '6',
    'format': 'json',
    }
...
for image in r.json()['query']['search']:
    # print(image['pageid'])
    URL = 'http://commons.wikimedia.org/entity/M'+str(image['pageid'])
    # http://commons.wikimedia.org/entity/M15925090
    r = requests.get(url=URL+".ttl")
    mpageid.append(URL)
    # # print(r.content)
